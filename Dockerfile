...
#
# Production image for mind-chat. Two stages:
...
#
# bookworm-slim for parity with the other Mind images. chat is a client-only
# SPA with no native modules, so no C toolchain is installed.
