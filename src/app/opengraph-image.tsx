...
export const alt = "Mind Chat — your messages in your pod";
  ...
  return new ImageResponse(
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 22 }}>
        ...
        <span style={{ fontSize: 60, fontWeight: 700, letterSpacing: -1 }}>Chat</span>
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        Messages in your pod · built on Solid
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        <span style={{ color: "#16b88a" }}>Your pod.</span>
      </div>
      <div
        style={{ display: "flex", fontSize: 34, color: "#9aa6b2", marginTop: 28, maxWidth: 900 }}
      >
        Privacy-first real-time chat built on Solid Pods — your messages live in the space you own,
        delivered over WebSocketChannel2023 with no central chat server.
      </div>
