...
/**
 * Appearance control. Two independent axes:
 *   • mode  — light / dark, owned by next-themes (useMindTheme().setMode)
 *   • brand — Mind / Deep Space, owned by <ThemeShell> (useBrand)
 *
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-44">
        ...
        <DropdownMenuRadioGroup
          value={brand}
          onValueChange={(v) => setBrand(v === "deepspace" ? "deepspace" : "mind")}
        >
          <DropdownMenuRadioItem value="mind" data-testid="brand-mind">
            Mind
          </DropdownMenuRadioItem>
          <DropdownMenuRadioItem value="deepspace" data-testid="brand-deepspace">
            Deep Space
          </DropdownMenuRadioItem>
        </DropdownMenuRadioGroup>
      </DropdownMenuContent>
